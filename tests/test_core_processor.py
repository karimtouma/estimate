...
class TestPDFProcessorConfiguration:
    ...
    def test_get_analysis_config(self):
        ...
        discovery_result = {"document_type": "Construction Documents", "industry_domain": "AEC"}

        prompt, schema = self.processor._get_analysis_config(AnalysisType.GENERAL, discovery_result)
    ...
    def test_get_schema_for_different_types(self):
        ...
        analysis_types = [AnalysisType.GENERAL, AnalysisType.SECTIONS, AnalysisType.DATA_EXTRACTION]
...
class TestPDFProcessorStatistics:
    ...
    def test_conversation_history_management(self):
        ...
        entry = {"timestamp": 12345, "type": "question", "content": "Test question"}
...
class TestPDFProcessorMethods:
    ...
    def test_create_adaptive_prompt_structure(self):
        ...
        prompt = self.processor._create_adaptive_prompt(
            analysis_type, discovery_result, "English language instruction."
        )
